...
@XmlType(
  name = "Subtype",
  propOrder = {"subtypeName", "subtypeCode", "fieldInfos"}
)
public class Subtype {
   ...
   *
   * @return possible object is {@link ArrayOfSubtypeFieldInfo }
   */
   ...
   *
   * @param value allowed object is {@link ArrayOfSubtypeFieldInfo }
   */
