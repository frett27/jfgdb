...
/**
 * Java class for ArrayOfPropertySetProperty complex type.
 *
...
@XmlType(
  name = "ArrayOfPropertySetProperty",
  propOrder = {"propertySetProperty"}
)
public class ArrayOfPropertySetProperty {
   ...
   * there is not a <CODE>set</CODE> method for the propertySetProperty property.
   *
   ...
   * </pre>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link PropertySetProperty }
   */
