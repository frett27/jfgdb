...
@XmlType(
  name = "TopologyMembership",
  propOrder = {"topologyName", "weight", "xyRank", "zRank", "eventNotificationOnValidate"}
)
public class TopologyMembership extends ControllerMembership {
