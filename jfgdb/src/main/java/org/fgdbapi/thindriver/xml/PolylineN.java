...
/**
 * Java class for PolylineN complex type.
 *
 ...
 *   &lt;complexContent>
 *     &lt;extension base="{http://www.esri.com/schemas/ArcGIS/10.1}Polyline">
 *       &lt;sequence>
 ...
 *         &lt;element name="PathArray" type="{http://www.esri.com/schemas/ArcGIS/10.1}ArrayOfPath"/>
...
@XmlType(
  name = "PolylineN",
  propOrder = {"hasID", "hasZ", "hasM", "extent", "pathArray", "spatialReference"}
)
public class PolylineN extends Polyline {
   ...
   *
   * @return possible object is {@link ArrayOfPath }
   */
   ...
   *
   * @param value allowed object is {@link ArrayOfPath }
   */
