...
/**
 * this class permit to unpack the shared DLL, this is mandatory prior to the usage on linux OS, due
 * to DLOpen OS primitive, so dependencies can't be loaded if not declared in LD_LIBRARY_PATH
 *
 * @author pfreydiere
 */
